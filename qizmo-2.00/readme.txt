...
lots of small stuff. Supported QW versions are: 2.0x, 2.1, 2.21.
...
should do the job (with latest drivers)) and DirectX 5 installed.
...
Show closest mark:
  Displays closest mark.

Delete closest mark:
  Deletes closest mark.

Mark current location:
  Marks current location (asks for a name).
...
View say_team %-codes:
  ...
  %A : Substitutes this for Armour type.
  %a : Substitutes this for Armour.
  %b : Substitutes this for Best Weapon and Ammo.
  %e : Substitutes this for number of enemies in your vicinity
  %h : Substitutes this for Current Health.
  %l : Substitutes this for Nearest location you have previously marked.
  %n : will only send the message to teammates in your vicinity.
  %o : Substitutes this for Number of Teammates in vicinity.
  %p : Substitutes this for Powerups.
  %w : Substitutes this for Weapon in Hand and Ammo you have.



Observer mode

To get best results, connect through a qizmo running on the same
machine as qwcl.
...
Misc stuff
  ...
  Gib filter: [on|off]
    If you have ever player DM6 DMM3 with 20 players you will
  ...
  can say "20 2345678", and next time you use impulse 20, Qizmo
  will choose the last weapon of that list, you have ammo for. So
  ...
  Info of players playing at same server as you.
...
32 = Disable %e enemy vicinity reporting (every TF server should use this one)
